...
- 這是一則 carousel（多圖）貼文，五個 repo 名稱分散在各張圖中；本次僅抓到貼文主文與痛點清單，**未能抓到每個 repo 的完整名稱與連結**（IG 擋爬）。要用時需回原貼文逐張看。
  - 取得方式：作者把「安裝指令、使用情境、幾個免費 skills」整理成一份文件，**在貼文留言「REPO」即私訊索取**（貼文 2026-08-09 發布，600+ 留言多為索取者）。
